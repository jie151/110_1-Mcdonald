...
import SetShareBoxCN from './setShareBoxCN';
import foodFromDB from './foodFromDB';
class ShareBoxCN extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            singleormeal: '2',//meal
                ...
                <div className="Ibox">
                    ...
                    <div class="inner">
                        <div class="wrapper">
                            ...
                            <div class="clear"></div>
                            <div>< SetShareBoxCN category_id={this.props.category_id} food={this.state.food} f_id={this.state.f_id.toString(10)} user_ID={this.props.user_ID} /></div>
...
export default withCookies(ShareBoxCN);
