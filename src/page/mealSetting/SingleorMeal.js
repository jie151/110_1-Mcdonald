...
class SetMeal extends React.Component {
    ...
    componentDidMount() {
        ...
        async function setdata(self) {
            try {
                console.log("singleormeal : set start");
                ...
                console.log("singleorMeal =>:",Addtemp);
                ...
                const sidetemp = await sideFromDB();
    ...
    handleAddtoCart = event => {
        ...
        console.log("singleorMeal => data:" ,data);
...
export default withCookies(SetMeal)
