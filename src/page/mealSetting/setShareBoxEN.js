...
class SetShareBoxEN extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            drinkCustomizeList1: [],
            drink1: 'Coca-Cola(M)',
            drinkCustomize1: "ice normal",
            drinkPrice1: 0,
            food: undefined,

            drinkCustomizeList2: [],
            drink2: 'Coca-Cola(M)',
            drinkCustomize2: "ice normal",
            drinkPrice2: 0,
    ...
    componentDidMount() {
        ...
        async function setdata(self) {
            try {
                ...
                const s_name_EN = await foodFromDB(sidet.f_id.toString(10));
                const s_name = s_name_EN.f_name_EN + "  *" + sidet.box_count;
                await self.setState({ side: s_name });

                console.log(s_name);
                //get main meal from share box
                var sidetemp1 = await sharetemp1;
                var sidet1 = sidetemp1.find(function (e) {
                    return e.f_id > 100;
                });
                const food_name_EN = await foodFromDB(sidet1.f_id.toString(10));
                await self.setState({ food: food_name_EN.f_name_EN });
    ...
    handleDrinkChange1 = event => {
        ...
        this.setState({
            drink1: this.state.drinkList[event.target.value].f_name_EN,
    ...
    handledrinkCustomizeChange1 = event => {
        this.setState({ drinkCustomize1: this.state.drinkCustomizeList1[event.target.value - 1].option_EN });
        console.log(event.target.value);
    };
    ...
    handleDrinkChange2 = event => {
        ...
        this.setState({
            drink2: this.state.drinkList[event.target.value].f_name_EN,
    ...
    handledrinkCustomizeChange2 = event => {
        this.setState({ drinkCustomize2: this.state.drinkCustomizeList2[event.target.value - 1].option_EN });
        console.log(event.target.value);
    };
                ...
                <table>
                    <tr>
                        ...
                        <td class="td2">
                            ...
                            <ul class="list">
                                <li className='lii'>{this.props.food.f_name_EN}<br />&emsp;- {this.state.food}</li>
...
export default withCookies(SetShareBoxEN)
