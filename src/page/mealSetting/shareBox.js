...
import SetShareBox from './setShareBox';
    ...
    componentDidMount() {
        ...
        async function setdata(self) {
            try {
                ...
                console.log("shareBox.js => foodtemp from firebase", foodtemp);
            }
            catch (err) {
                console.log(err);
            }
                ...
                <div className="Ibox">
                    ...
                    <div class="inner">
                        <div class="wrapper">
                            ...
                            <div class="clear"></div>
                            <div>< SetShareBox food={this.state.food} f_id = {this.state.f_id.toString(10)} user_ID={this.props.user_ID} /></div>
...
export default withCookies(ShareBox);
